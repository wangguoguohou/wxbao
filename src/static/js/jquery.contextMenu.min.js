            ...
            o.prototype = {
                init : function(t, n) {
                    this.ele = t, this.defaults = {
                        ...
                        hoverColor : "#fff",
                        hoverBgColor : "#00a1e3"
                    }, this.opts = i.extend(!0, {}, this.defaults, n), this.random = (new Date).getTime()
                        ...
                        var e = this.opts.menu, o = '<ul class="ui-context-menu" id="uiContextMenu_' + this.random
                                ...
                                i
                                        .each(
                                                e,
                                                function(t, n) {
                                                    n.icon ? o += '<li class="ui-context-menu-item"><a href="javascript:void(0);"><img class="icon" src="'
                                                            + n.icon + '"/><span>' + n.text + "</span></a></li>"
                                                            : o += '<li class="ui-context-menu-item"><a href="javascript:void(0);"><span>'
                                                                    + n.text + "</span></a></li>"
                ...
                menuItemClick : function(t) {
                    ...
                    t.parent(".ui-context-menu").hide(), n.opts.menu[i].callback
                            && "function" == typeof n.opts.menu[i].callback && n.opts.menu[i].callback()
                },
                ...
                eventBind : function() {
                    ...
                    this.ele.on("contextmenu", function(n) {
                        n.preventDefault(), t.renderMenu(), t.setPosition(n), t.opts.target
                                && "function" == typeof t.opts.target && t.opts.target(i(this))
