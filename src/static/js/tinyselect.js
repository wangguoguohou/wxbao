...
;(function($) {
  ...
  var TinySelect = {
	...
	onSelectLiClicked: function(e) {
        ...
        self.state.selectBox.css("color","#666")
		self.state.selectedValue = item.attr("data-value");
		self.state.$el.val(self.state.selectedValue);
		self.state.$el.trigger("change");
        self.state.$el.css("color","#666");
       /* $("#muduleTypeUl").css("border-bottom","");
        $("#moduleUl").css("border-bottom","");
        $("#inverterCompanyUl").css("border-bottom","");
        $("#inverterTypeUl").css("border-bottom","");*/
	},
