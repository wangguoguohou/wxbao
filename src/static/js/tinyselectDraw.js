  ...
  var TinySelect = {
	...
	onSelectBoxClicked: function(e) {
		...
		if( self.state.open )
		{
			...
			self.state.selectBox.removeClass("icon_arrow3_up");
		...
		self.state.selectBox.addClass("icon_arrow3_up open");
